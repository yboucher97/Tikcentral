"""Enhanced enrollment UI with selectable E50 performance profiles."""
...
def _apply_profile(script: str, profile: str) -> str:
    """Set initial state for the performance components already staged in script."""
    if profile == "fairness":
        commands = r'''
