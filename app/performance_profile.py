...
- A lightweight TCP MSS clamp is enabled for PPPoE/MTU reliability.
...
# Clamp MSS only on TCP connection setup. This is cheap and protects against
# PMTU/PPPoE black-hole behavior without putting established traffic through a
