...
<div class="panel"><table><thead><tr><th>Model</th><th>Observed</th><th>Architecture</th><th>CPU / cores</th><th>Memory</th><th>Storage</th><th>Ethernet</th><th>SFP</th><th>LTE</th><th>Wi-Fi</th><th>WireGuard</th></tr></thead><tbody>{rendered}</tbody></table></div>'''
